...
### Note about the gender collection updates for 2023-2024 reporting cycle
  
These update affect the scripts for Completions, 12 Month Enrollment, Graduation Rates, and Fall Enrollment.
  
Scripts are set to assume that you ARE able to report on "another gender" in this reporting cycle.
